...
7. In **Settings → Plugins → Detour**, confirm the connection is present. If Actions is empty, click **Refresh**; the catalog should include `get_trip`, `search_places`, seven trip edit actions, and `import_photo` / `remove_photo`.
